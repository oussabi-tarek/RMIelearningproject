...
//        }
        ...
        private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
            // TODO add your handling code here:
            try {
                if(jButton1.getText().contains("Connexion")) {
                    ...
                    if (inscrit == 1) {
                        ...
                        jLabel1.setText("Objet du Cours:");
                        jTextField1.setText("");
                        ...
                        jButton1.setText("Lancer le Cours      ");
...
//                    this.dispose();
                    ...
                    String objectifcours=jTextField1.getText();
                    // add the course to the Server
//                    Server.cours.put(this.name,objectifcours);
//                    System.out.println("cours : "+Server.cours.keySet());
                    DatabaseConnection db = new DatabaseConnection();
                    String query = "INSERT INTO cours (objet,prof_id) VALUES ('"+objectifcours+"',"+id+")";
                    db.getStatement().executeUpdate(query);
                    String url="rmi://localhost/paint";
                    System.out.println("voila : "+this.name);
                    try {
                        Pain od=(Pain) Naming.lookup(url);
                        od.principale("Prof "+this.name,"");
                    }catch (Exception e){
                        System.out.println("Serveur Introuvable");
                        e.printStackTrace();
                    }
