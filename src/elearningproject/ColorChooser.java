...
public class ColorChooser extends JPanel implements ActionListener {
    JButton red, black, green, orange, blue, pink, brown, yellow, white, cyan, purple, gray, darkgrey;
    Elearning frame;
    public ColorChooser(Elearning frame) {
        this.frame = frame;
        ...
        darkgrey = new JButton("");
        darkgrey.setSize(25, 25);
        darkgrey.setBackground(Color.darkGray);
    ...
    public void actionPerformed(ActionEvent e) {
        JButton btn = (JButton) e.getSource();// get the button source of the event
